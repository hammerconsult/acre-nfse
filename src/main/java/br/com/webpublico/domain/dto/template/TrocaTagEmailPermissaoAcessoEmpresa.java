...
public class TrocaTagEmailPermissaoAcessoEmpresa extends TrocaTag {

    private PrestadorServicoNfseDTO prestadorServicos;
    private MunicipioNfseDTO municipio;
    private UserNfseDTO user;

    public TrocaTagEmailPermissaoAcessoEmpresa(PrestadorServicoNfseDTO prestadorServicos,
                                               UserNfseDTO user, ConfiguracaoNfseDTO configuracaoTributario) {
        super(TipoTemplateNfse.PERMISSAO_ACESSO_EMPRESA, configuracaoTributario);
    ...
    public void adicionarFields() {
        ...
        addicionarField(new Field(TagComum.ESTADO, municipio.getNome()));
