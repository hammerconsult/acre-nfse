...
public enum ExigibilidadeNfseDTO implements NfseEnumDTO {
    ...
    public static br.com.webpublico.domain.dto.enums.ExigibilidadeNfseDTO getByCodigo(Integer codigo) {
        for (br.com.webpublico.domain.dto.enums.ExigibilidadeNfseDTO exigibilidade : values()) {
    ...
    public static br.com.webpublico.domain.dto.enums.ExigibilidadeNfseDTO getByCodigoV1(Integer codigo) {
        for (br.com.webpublico.domain.dto.enums.ExigibilidadeNfseDTO exigibilidade : values()) {
