...
public class ConfiguracaoNfseDTO implements Serializable, NfseDTO {
    ...
    private Integer diaLimiteCancelamentoEncerramentoMensal;
    private Boolean utilizaBancoCache;
    private Integer prazoAvisoNovaMensagem;
    private List<String> gruposObrigatoriosCosif;
    private TipoManualDTO tipoManualDesif;
    private String urlNotaPremiada;

    public ConfiguracaoNfseDTO() {

    }

    public ConfiguracaoNfseDTO(Long id, MunicipioNfseDTO municipio, Boolean verificarAidfe) {
        this.id = id;
    ...
    public Integer getDiaLimiteCancelamentoEncerramentoMensal() {
        return diaLimiteCancelamentoEncerramentoMensal;
    }

    public void setDiaLimiteCancelamentoEncerramentoMensal(Integer diaLimiteCancelamentoEncerramentoMensal) {
        this.diaLimiteCancelamentoEncerramentoMensal = diaLimiteCancelamentoEncerramentoMensal;
    }

    public Boolean getUtilizaBancoCache() {
        return utilizaBancoCache;
    }

    public void setUtilizaBancoCache(Boolean utilizaBancoCache) {
        this.utilizaBancoCache = utilizaBancoCache;
    }

    public Integer getPrazoAvisoNovaMensagem() {
        return prazoAvisoNovaMensagem != null ? prazoAvisoNovaMensagem : 1;
    }

    public void setPrazoAvisoNovaMensagem(Integer prazoAvisoNovaMensagem) {
        this.prazoAvisoNovaMensagem = prazoAvisoNovaMensagem;
    }

    public List<String> getGruposObrigatoriosCosif() {
        return gruposObrigatoriosCosif;
    }

    public void setGruposObrigatoriosCosif(List<String> gruposObrigatoriosCosif) {
        this.gruposObrigatoriosCosif = gruposObrigatoriosCosif;
    }

    public TipoManualDTO getTipoManualDesif() {
        return tipoManualDesif;
    }

    public void setTipoManualDesif(TipoManualDTO tipoManualDesif) {
        this.tipoManualDesif = tipoManualDesif;
    }

    public String getUrlNotaPremiada() {
        return urlNotaPremiada;
    }

    public void setUrlNotaPremiada(String urlNotaPremiada) {
        this.urlNotaPremiada = urlNotaPremiada;
    }
}
