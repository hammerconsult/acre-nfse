...
public class DadosPessoaisNfseDTO implements NfseDTO, Cloneable {
    ...
    public String getPrimeiros8DigitosCpfCnpj() {
        String ultimos = StringUtils.removerMascaraCpfCnpj(cpfCnpj);
        return ultimos.substring(0, 8);
    }
    ...
    @Override
    public br.com.webpublico.domain.dto.DadosPessoaisNfseDTO clone() throws CloneNotSupportedException {
        br.com.webpublico.domain.dto.DadosPessoaisNfseDTO cloneable = new br.com.webpublico.domain.dto.DadosPessoaisNfseDTO();
    ...
    public String toString() {
        return nomeRazaoSocial + " (" + cpfCnpj + ") ";
    }
}
