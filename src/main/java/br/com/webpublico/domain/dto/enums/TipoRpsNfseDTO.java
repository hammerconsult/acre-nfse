...
public enum TipoRpsNfseDTO implements NfseEnumDTO {
    ...
    public static br.com.webpublico.domain.dto.enums.TipoRpsNfseDTO findByCodigo(int codigo) {
        for (br.com.webpublico.domain.dto.enums.TipoRpsNfseDTO tipoRpsNfseDTO : values()) {
