(function () {
    ...
    angular.module('nfseApp').controller('DeclaracaoMensalServicoEditController',
            ...
            function acessarCompetencia() {
                ...
                NotaFiscal.buscarResumoSemDeclararPorCompetencia({
                    ...
                    function (result) {
                        ...
                        $scope.declaracaoMensalServico.totalIssRetido = result.totalIssRetido;
                        $scope.declaracaoMensalServico.totalIss = result.totalIssDevido;
