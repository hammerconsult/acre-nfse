...
public class AnexoLei1232006NfseDTO extends AbstractEntity implements RowMapper<AnexoLei1232006NfseDTO> {
    ...
    private List<AnexoLei1232006FaixaNfseDTO> faixas;
    ...
    public List<AnexoLei1232006FaixaNfseDTO> getFaixas() {
        return faixas;
    }

    public void setFaixas(List<AnexoLei1232006FaixaNfseDTO> faixas) {
        this.faixas = faixas;
    }

    @Override
    public AnexoLei1232006NfseDTO mapRow(ResultSet resultSet, int i) throws SQLException {
        AnexoLei1232006NfseDTO dto = new AnexoLei1232006NfseDTO();
        dto.setId(resultSet.getLong("id"));
        dto.setDescricao(resultSet.getString("descricao"));
        dto.setVigenteAte(resultSet.getDate("vigenteate"));
        dto.setIrpjExcedente(resultSet.getBigDecimal("irpjexcedente"));
        dto.setCsllExcedente(resultSet.getBigDecimal("csllexcedente"));
        dto.setCofinsExcedente(resultSet.getBigDecimal("cofinsexcedente"));
        dto.setPisPasepExcedente(resultSet.getBigDecimal("pispasepexcedente"));
        dto.setCppExcedente(resultSet.getBigDecimal("cppexcedente"));
        dto.setIcmsExcedente(resultSet.getBigDecimal("icmsexcedente"));
        dto.setIpiExcedente(resultSet.getBigDecimal("ipiexcedente"));
        return dto;
    }
}
