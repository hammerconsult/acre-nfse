...
public class Nfse12ServiceTest extends ApplicationContextTest {
//
//    @Autowired
//    private Nfse12Service nfse12Service;
//
//    @Test
//    public void cancelarNfse() throws ValidacaoNfseWSException, DatatypeConfigurationException {
...
//        cancelarNfseEnvio.getPedido().getInfPedidoCancelamento().setNumero(new BigInteger("3"));
//        cancelarNfseEnvio.getPedido().getInfPedidoCancelamento().setChaveAcesso(null);
//
//        CancelarNfseResposta cancelarNfseResposta = nfse12Service.cancelar(cancelarNfseEnvio);
//
...
//
//        ConsultarNfseFaixaResposta consultarNfseFaixaResposta = nfse12Service.consultarNfseFaixa(consultarNfseFaixaEnvio);
//
//        Assert.assertNotNull(consultarNfseFaixaResposta);
//        Assert.assertNotNull(consultarNfseFaixaResposta.getListaConsultaNfse());
//        Assert.assertNotNull(consultarNfseFaixaResposta.getListaConsultaNfse().getCompNfse());
//        Assert.assertEquals(10, consultarNfseFaixaResposta.getListaConsultaNfse().getCompNfse().size());
//    }
//
//    @Test
//    public void consultarNfseRps() throws Exception, ValidacaoNfseWSException {
...
//
//        ConsultarNfseRpsResposta consultarNfseRpsResposta = nfse12Service.consultarNfseRps(consultarNfseRpsEnvio);
//
...
//
//        ConsultarLoteRpsResposta consultarLoteRpsResposta = nfse12Service.consultarLoteRps(consultarLoteRpsEnvio);
//
...
//
//        ConsultarNfseServicoPrestadoResposta consultarNfseServicoPrestadoResposta = nfse12Service.consultarServicoPrestado(consultarNfseServicoPrestadoEnvio);
//
//        Assert.assertNotNull(consultarNfseServicoPrestadoResposta);
//        Assert.assertEquals(3, consultarNfseServicoPrestadoResposta.getListaConsultaNfse().getCompNfse().size());
//    }
//
//    @Test
...
//        declaracaoPrestacaoServico.getInfDeclaracaoPrestacaoServico().setDadosPrestador(new TcDadosPrestador());
//        declaracaoPrestacaoServico.getInfDeclaracaoPrestacaoServico().getDadosPrestador().setIdentificacaoPrestador(new TcIdentificacaoPrestador());
//        declaracaoPrestacaoServico.getInfDeclaracaoPrestacaoServico().getDadosPrestador().getIdentificacaoPrestador().setCpfCnpj(new TcCpfCnpj());
//        declaracaoPrestacaoServico.getInfDeclaracaoPrestacaoServico().getDadosPrestador().getIdentificacaoPrestador().getCpfCnpj().setCnpj("09032577000150");
//        declaracaoPrestacaoServico.getInfDeclaracaoPrestacaoServico().getDadosPrestador().getIdentificacaoPrestador().setInscricaoMunicipal("9033572");
//        declaracaoPrestacaoServico.getInfDeclaracaoPrestacaoServico().getDadosPrestador().setRazaoSocial("MGA GESTAO PUBLICA LTDA");
...
//
//        lote.getLoteRps().getListaRps().getDeclaracaoPrestacaoServico().add(declaracaoPrestacaoServico);
//
//        EnviarLoteRpsSincronoResposta enviarLoteRpsSincronoResposta = nfse12Service.enviarLoteWsSincrono(lote, "");
//
...
//
//        substituirNfseEnvio.setPedido(new TcPedidoCancelamento());
//        substituirNfseEnvio.getPedido().setInfPedidoCancelamento(new TcInfPedidoCancelamento());
//        substituirNfseEnvio.getPedido().getInfPedidoCancelamento().setNumero(new BigInteger("3"));
//        substituirNfseEnvio.getPedido().getInfPedidoCancelamento().setChaveAcesso("");
//        substituirNfseEnvio.getPedido().getInfPedidoCancelamento().setCodigoCancelamento(new Integer("1").byteValue());
//
//        TcDeclaracaoPrestacaoServico declaracaoPrestacaoServico = new TcDeclaracaoPrestacaoServico();
//        declaracaoPrestacaoServico.setInfDeclaracaoPrestacaoServico(new TcInfDeclaracaoPrestacaoServico());
//        declaracaoPrestacaoServico.getInfDeclaracaoPrestacaoServico().setCompetencia(DateUtils.convertDateToXMLGregorianCalendar(new Date()));
...
//        declaracaoPrestacaoServico.getInfDeclaracaoPrestacaoServico().getTomador().getContato().setTelefone("44998026110");
//
//        substituirNfseEnvio.setDeclaracaoPrestacaoServico(declaracaoPrestacaoServico);
//
//        SubstituirNfseResposta substituirNfseResposta = nfse12Service.substituirNnfseWs(substituirNfseEnvio);
//
