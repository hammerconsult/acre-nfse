...
public class AnexoLei1232006FaixaNfseDTO implements NfseDTO, RowMapper<AnexoLei1232006FaixaNfseDTO> {
    ...
    @Override
    public AnexoLei1232006FaixaNfseDTO mapRow(ResultSet resultSet, int i) throws SQLException {
        AnexoLei1232006FaixaNfseDTO dto = new AnexoLei1232006FaixaNfseDTO();
        dto.setId(resultSet.getLong("id"));
        dto.setFaixa(resultSet.getString("faixa"));
        dto.setAliquota(resultSet.getBigDecimal("aliquota"));
        dto.setValorMaximo(resultSet.getBigDecimal("valormaximo"));
        dto.setAliquota(resultSet.getBigDecimal("aliquota"));
        dto.setValorDeduzir(resultSet.getBigDecimal("valordeduzir"));
        dto.setIrpj(resultSet.getBigDecimal("irpj"));
        dto.setCsll(resultSet.getBigDecimal("csll"));
        dto.setCofins(resultSet.getBigDecimal("cofins"));
        dto.setPisPasep(resultSet.getBigDecimal("pispasep"));
        dto.setCpp(resultSet.getBigDecimal("cpp"));
        dto.setIcms(resultSet.getBigDecimal("icms"));
        dto.setIpi(resultSet.getBigDecimal("ipi"));
