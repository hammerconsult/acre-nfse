...
public class ImpressaoNotaFiscalNfseDTO implements NfseDTO {
    ...
    public ImpressaoNotaFiscalNfseDTO() {
        item = new ImpressaoNotaFiscalNfseItemDTO();
        issqn = new ImpressaoNotaFiscalNfseImpostoDTO();
        cofins = new ImpressaoNotaFiscalNfseImpostoDTO();
        cpp = new ImpressaoNotaFiscalNfseImpostoDTO();
        csll = new ImpressaoNotaFiscalNfseImpostoDTO();
        inss = new ImpressaoNotaFiscalNfseImpostoDTO();
        irrf = new ImpressaoNotaFiscalNfseImpostoDTO();
        pis = new ImpressaoNotaFiscalNfseImpostoDTO();
        outrasRetencoes = new ImpressaoNotaFiscalNfseImpostoDTO();
        totalTributos = new ImpressaoNotaFiscalNfseImpostoDTO();
    }
