...
public enum PermissaoUsuarioEmpresaNfse implements NfseEnumDTO {
    ...
    public static List<br.com.webpublico.domain.dto.enums.PermissaoUsuarioEmpresaNfse> getTodasMenosAdmin() {
        List<br.com.webpublico.domain.dto.enums.PermissaoUsuarioEmpresaNfse> retorno = Lists.newArrayList(br.com.webpublico.domain.dto.enums.PermissaoUsuarioEmpresaNfse.values());
