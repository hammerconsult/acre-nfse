(function () {
    ...
    angular.module('nfseApp')
        .controller('DeclaracaoMensalServicoRetencaoController',
            function ($scope, DeclaracaoMensalServico, DeclaracaoMensalServicoSearch, ParseLinks, Notificacao, ImpressaoPdf,
                      localStorageService, Util) {
                ...
                $scope.imprimeRelatorioDMS = function (ano, mes) {
                    ImpressaoPdf.imprimirPdfViaUrl('/api/imprimir-relatorio-dms/' + ano + "/" + mes + "/RETENCAO");
                };
