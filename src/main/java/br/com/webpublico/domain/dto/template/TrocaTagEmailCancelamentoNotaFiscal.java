 ...
 */
public class TrocaTagEmailCancelamentoNotaFiscal extends TrocaTag {

    private NotaFiscalNfseDTO notaFiscal;

    public TrocaTagEmailCancelamentoNotaFiscal(NotaFiscalNfseDTO notaFiscal, ConfiguracaoNfseDTO configuracaoTributario) {
        super(TipoTemplateNfse.NFSE_CANCELADA_TOMADOR, configuracaoTributario);
